...
public class Ejercicio03 {
    public static void main(String[] args) {
         ...
         * 20 y que los muestre en pantalla seperados por espacios. El programa pedira
         * entonces
         * por teclado dos valores y a continuacion cambiara cambiara todas las
         * ocurrencias del primer
         * valor por el segundo en la lista generada anteriormente. los numeros que se
         * han cambiado deben
