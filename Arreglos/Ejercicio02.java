...
public class Ejercicio02 {
    public static void main(String[] args) {
        /*
         * Ejercicio 2. Escribe un programa que lea 15 numeros por teclado y que los
         * almacene
         * en un array, rota los elementos de ese array, es decir, el elemento de la
         * posicion 0 debe pasar
         * a la posición 1, el de la 1 a la 2, etc. el numero que se encuentra en la
         * ultima posicion
